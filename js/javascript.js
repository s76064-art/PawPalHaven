            ...
            if (slidePets.length === 3 || index === pets.length - 1) {
                ...
                const cardsHTML = await Promise.all(
                    slidePets.map(async pet => {
                        ...
                        return `
                    <div class="col-md-4">
                        <div class="card home-pet-card shadow-sm border-0 mb-4">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="text-muted mb-1">${pet.breed || "Unknown breed"}</p>
                                <p class="small">${pet.age || "Age not listed"}</p>

                                <a href="petDetails.html?id=${pet.id}" class="btn btn-success mt-2">View Me</a>
